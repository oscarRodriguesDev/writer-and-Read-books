...
export const cardCls =
  "rounded-xl border border-line fundo-papel p-5 shadow-sm";

export const cardInterativo =
  "rounded-xl border border-line fundo-papel p-5 shadow-sm hover:shadow-lg hover:border-accent/30 transition-all duration-normal cursor-pointer";
